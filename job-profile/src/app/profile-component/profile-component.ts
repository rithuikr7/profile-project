...
user = {
    ...
    skills: ['Angular', 'C#', 'Kubernetes', 'Azure', 'Docker', 'TypeScript', 'HTML', 'SCSS'],
    projects: [
      {
        name: 'Microfrontend Dashboard',
        description: 'Modular dashboard using Angular + Module Federation + Auth.',
        link: 'https://github.com/rithuik/microfrontend-dashboard'
      },
      {
        name: 'Cloud Cost Tracker',
        description: 'Azure-native app to track and optimize cloud costs in real time.',
